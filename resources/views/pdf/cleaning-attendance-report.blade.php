...
<head>
    <meta charset="utf-8">
    <title>Rekap Absensi {{ $cleaningUser->name }} - {{ $monthLabel }}</title>
    <style>
        @page {
            margin: 12mm;
        }
...
<body>
    <div class="header">
        <h1 class="title">Rekap Absensi Kebersihan</h1>
        <p class="subtitle">Statistik dan rekap bulanan untuk laporan internal admin</p>

        <table class="meta">
            <tr>
                <td style="width: 18%;"><strong>Petugas</strong></td>
                <td style="width: 2%;">:</td>
                <td>{{ $cleaningUser->name }}</td>

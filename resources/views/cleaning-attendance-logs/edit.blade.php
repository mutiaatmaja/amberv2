...
<x-layouts.app :title="'Ubah Absensi Kebersihan | ' . config('app.name', 'Amber')" heading="Ubah Absensi Kebersihan">
        ...
        <section
            ...
            <div class="mb-6 rounded-2xl bg-slate-50 px-5 py-4 dark:bg-slate-800/50">
                <dl class="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
                    <dt class="font-medium text-slate-500 dark:text-slate-400">Kebersihan</dt>
            ...
            <h3 class="text-xl font-semibold">Form Ubah Absensi Kebersihan</h3>
            <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
            ...
            <form method="POST" action="{{ route('cleaning-attendance-logs.update', $log) }}" class="mt-6 space-y-5"
                ...
                <div class="flex items-center justify-end gap-3 pt-2">
                    <a href="{{ route('cleaning-attendance-logs.index', ['user_id' => $log->user_id]) }}" wire:navigate
